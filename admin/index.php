...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="info-box bg-green">
        <span class="info-box-icon bg-info elevation-1"><i class="ion ion-cash"></i></span>
        <div class="info-box-content">
          ...
          <?php echo "Rp. ".number_format($p['total_pemasukan'])." ,-" ?>
        </div>
      </div>
    </div>
...
<!--     
      ...
      <div class="info-box bg-black">
        <span class="info-box-icon bg-info elevation-1"><i class="ion-stats-bars"></i></span>
        <div class="info-box-content">
          <span class="info-box-text">Seluruh Pemasukan</span>
          <?php 
